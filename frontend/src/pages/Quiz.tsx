          ...
          <div className="max-w-2xl w-full text-center">
            ...
            <div className="max-w-sm mx-auto mb-8 text-left">
              ...
              <input
                  ...
                  className="w-full px-4 py-3 bg-floresta-900 text-neve border border-floresta-800 rounded-xl focus:outline-none focus:border-outono-500 font-body text-sm transition-colors"
              />
            </div>
            ...
            <button
                ...
                disabled={!nameUser.trim()}
                className={clsx(
                    "btn-primary text-base px-10 py-4 mx-auto",
                    !nameUser.trim() && "opacity-50 cursor-not-allowed hover:translate-y-0"
                )}
            >
              Começar Quiz
              <ArrowRight size={18} />
          ...
          <div className="max-w-2xl w-full">
            <div className="bg-floresta-900 rounded-3xl p-8 md:p-12 text-center border border-floresta-800/40">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/ranking" className="btn-outline flex items-center gap-2">
                  Ver Tabela
                </Link>
          ...
          <span className="font-body text-floresta-500 text-sm">
            ...
            {!confirmada ? (
                ...
                <button onClick={proximaQuestao} className="btn-primary">
                  {ehUltimaQuestao ? 'Finalizar Quiz' : 'Próxima questão'}
                  <ArrowRight size={16} />
                </button>
            )}
          </div>
